...
func main() {
	...
	case 14:
		if *part == "a" {
			result = day14.RunPartA()
		}
		if *part == "b" {
			result = day14.RunPartB()
		}
	case 15:
		if *part == "a" {
			result = day15.RunPartA()
		}
		if *part == "b" {
			result = day15.RunPartB()
		}
	case 16:
		if *part == "a" {
			result = day16.RunPartA()
		}
		if *part == "b" {
			result = day16.RunPartB()
		}
	case 17:
		if *part == "a" {
	...
	case 18:
		if *part == "a" {
			result = day18.RunPartA()
		}
		if *part == "b" {
			result = day18.RunPartB()
		}
	case 19:
		if *part == "a" {
			result = day19.RunPartA()
		}
		if *part == "b" {
			result = day19.RunPartB()
		}
	default:
